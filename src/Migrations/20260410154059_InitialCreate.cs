        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StorageOptions = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    DisplaySize = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    KeyFeatures = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StorageOption = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "ipad-pro-12-9", "Apple", "iPad", "[\"Space Gray\", \"Silver\"]", new DateTime(2024, 1, 3, 0, 0, 0, 0, DateTimeKind.Utc), "iPad Pro 12.9-inch với chip M2, màn hình Liquid Retina XDR", "12.9 inch", true, "[\"https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=500&h=500&fit=crop&crop=center\"]", true, "[\"Liquid Retina XDR\", \"Apple Pencil 2\", \"Magic Keyboard\", \"5G\"]", "iPad Pro 12.9-inch", null, 31990000m, "Apple M2", "iPad Pro", 4.5999999999999996, 142, "[\"128GB\", \"256GB\", \"512GB\", \"1TB\", \"2TB\"]" },
                    { "iphone-15-pro", "Apple", "iPhone", "[\"Natural Titanium\", \"Blue Titanium\", \"White Titanium\", \"Black Titanium\"]", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "iPhone 15 Pro với chip A17 Pro, camera 48MP và khung titan cao cấp", "6.1 inch", true, "[\"https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=500&h=500&fit=crop&crop=center\"]", true, "[\"Camera 48MP\", \"Action Button\", \"USB-C\", \"Titanium Design\"]", "iPhone 15 Pro", 30990000m, 28990000m, "A17 Pro", "iPhone 15 Pro", 4.7999999999999998, 256, "[\"128GB\", \"256GB\", \"512GB\", \"1TB\"]" },
                    { "macbook-air-m3", "Apple", "Mac", "[\"Midnight\", \"Starlight\", \"Space Gray\", \"Silver\"]", new DateTime(2024, 1, 2, 0, 0, 0, 0, DateTimeKind.Utc), "MacBook Air 13-inch với chip M3, thiết kế siêu mỏng và pin 18 giờ", "13.6 inch", true, "[\"https://images.unsplash.com/photo-1541807084-5c52b6b3adef?w=500&h=500&fit=crop&crop=center\"]", true, "[\"Chip M3\", \"Pin 18 giờ\", \"Liquid Retina Display\", \"MagSafe\"]", "MacBook Air 13-inch M3", null, 32990000m, "Apple M3", "MacBook Air", 4.7000000000000002, 189, "[\"256GB\", \"512GB\", \"1TB\", \"2TB\"]" }
                });
